<template>
  <div v-show="value">
    ...
    <img ref="targetImage" class="target-image" @load="imageLoaded" v-bind:style="imageStyle" v-bind:class="{'fade-in': fadeIn,'image-transition': !isMove}" :src="src" alt="">
...
export default {
  ...
  mounted() {
    ...
    // this.bindDrag();  // 这个是拖动图片的方法，这个方法有冲突
  },
  destroyed() {
